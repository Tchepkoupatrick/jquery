       ...
       <section>
        <div class="row">
            <div class="col-lg-12 bg-succes">
               ...
               <section>
                <center>
                    <i><h3 class="pt-2" style="color: darkcyan;">CHERE CLIENT(E) BIENVENUE CHEZ AUTOQUICK</h3></i>
                ...
                <div class="container-fliud">
                  <div class="col-lg-12">
                      <div class="row" style="margin: 5px;">
                          <div class="col-lg-3">
                              <div class="card-body">
                                <img src="vv1.png" alt="" style="width: 8cm;">
                               </div>
                          </div>

                          <div class="col-lg-3">
                            <div class="card-body">
                                <img src="vv2.png" alt="" style="width: 8cm;">
                            </div>
                           </div>

                       <div class="col-lg-3">
                           <div class="card-body">
                                 <img src="vv3.png" alt="" style="width: 8cm;">
                            </div>
                        </div>

                       <div class="col-lg-3">
                             <div class="card-body">
                                 <img src="vv4.png" alt="" style="width: 8cm;">
                              </div>
                       </div>
                        <p>thrbvecxs</p>
