...
<head>
    ...
    <title>Enregistrement.location</title>
</head>
                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">Enregistrement Location</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Nom client:<span style="color: white;">ffffff</span></b>
                                        <td><input type="text" size="30" name="nomclient" placeholder="    Nom du client " required></td>
                                    </tr>
                                </div>
                                
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Nom chauffeur:<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" size="30" name="nomchauffeur" placeholder="   Nom du chauffeur" required></td>
                                    </tr>
                                </div>

                                <div class="col-lg-6">
                                    <tr>
                                        <b>Contact chauffeur:<span style="color: white;">ffffff</span></b>
                                        <td><input type="text" size="30" name="contactchauffeur" placeholder="   contact cahuffeur" required></td>
                                    </tr>
                                </div>
                                
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Email client:<span style="color: white;">fffff</span></b>
                                        <td><input type="email" size="30" name="email" placeholder="Email Client" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Debut  :<span style="color: white;">fffffff</span></b>
                                        <td><input type="date" size="30" name="debut" placeholder="  Debut de la location " required></td>
                                    </tr>
                                </div> 

                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Fin :<span style="color: white;">fffffff</span></b>
                                        <td><input type="date" size="30" name="fin" placeholder="  Fin de la location " required></td>
                                    </tr>
                                </div> 
                               
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Contact client:<span style="color: white;">fffffffffffffffff</span></b>
                                        <td><input type="number" size="0" name="contactclient" placeholder="  contact client" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Marque  :<span style="color: white;">ffffffffffffffffffffffff</span></b>
                                        <td><input type="text" size="0" name="marque" placeholder="  Marque du vehicule" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>prix de location :<span style="color: white;">fffffFFFF</span></b>
                                        <td><input type="number" size="31" name="prix" placeholder=" prix de location" required></td>
                                    </tr>
                                </div>
                               
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Modèle :<span style="color: white;">fffffffffffff</span></b>
                                        <td><input type="text" size="30" name="modele" placeholder="  Modele du vehicule" required></td>
                                    </tr>
                                </div>
                                
                            </div>
                            <div class="d-flex mt-4" style="padding-left: 45%; gap: 2px;">
                                <i><a href="Enregistrement.vente.php" class="cancel btn btn-danger ms-4">annuler</a></i>
                                <i><input type="submit" value="Valider" name="done" class="connect btn btn-success ms-4"></i>
                            </div>
