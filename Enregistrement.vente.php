...
<head>
    ...
    <title>Enregistrement.vente</title>
</head>
                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">Enregistrement d'une Vente</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                    <tr>
                                        ...
                                        <td><input type="text" size="30" name="nom" placeholder="Nom Complet" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Marque :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" size="30" name="marque" placeholder="Marque du véhicule" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Email :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="email" size="30" name="email" placeholder="Email" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Modèle :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" size="30" name="modele" placeholder="  Modèle du véhicule" required></td>
                                    </tr>
                                </div> 
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        ...
                                        <td><input type="number" size="0" name="contact" placeholder="  Numero de téléphone" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Année :<span style="color: white;">ffffffffffffffffffffffff</span></b>
                                        <td><input type="date" size="0" name="annee" placeholder="  année d'imatriculation" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Kilométrage :<span style="color: white;">fffffffffFFFF</span></b>
                                        <td><input type="number" size="31" name="kilometre" placeholder=" Kilométrage" required></td>
                                    </tr>
                                </div>
                               
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>prix de vente :<span style="color: white;">ffffffffffffffff</span></b>
                                        <td><input type="number" size="30" name="prix" placeholder="  Montant versé" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Date de peaiment :<span style="color: white;">ffffffffffffffff</span></b>
                                        <td><input type="date" size="30" name="datee" placeholder="  Montant versé" required></td>
                                    </tr>
                                </div>
                                
                            </div>
                            <div class="d-flex mt-4" style="padding-left: 45%; gap: 2px;">
                                <i><a href="Enregistrement.vente.html" class="cancel btn btn-danger ms-4">annuler</a></i>
                                <i><input type="submit" value="Valider" name="azem" class="connect btn btn-success ms-4"></i>
                            </div>
