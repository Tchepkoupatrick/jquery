...
<head>
    ...
    <title>Enregistrement.reprise</title>
</head>
                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">Enregistrement Reprise</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                    <tr>
                                        ...
                                        <td><input type="text" size="30" placeholder="Nom Complet" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Encienne Marque :<span style="color: white;">ffffffff</span></b>
                                        <td><input type="text" size="30" placeholder="Marque du vehicule" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Email :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="email" size="30" placeholder="Email" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Encien Modèle :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" size="30" placeholder="  Modèle du vehicule" required></td>
                                    </tr>
                                </div> 
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        ...
                                        <td><input type="number" size="0" placeholder="  Numero de téléphone" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Nouvelle Marque  :<span style="color: white;">fffffffffffffffffffff</span></b>
                                        <td><input type="number" size="30" placeholder="  Marque du vehicule" required></td>
                                    </tr>
                                </div>

                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Nouveau Model :<span style="color: white;">ffffffffff</span></b>
                                        <td><input type="number" size="0" placeholder="  Model du vehicule" required></td>
                                    </tr>
                                </div>

                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Prix Ajouter<tfoot></tfoot> :<span style="color: white;">fffffffffffffffffffffffffff</span></b>
                                        <td><input type="number" size="0" placeholder="  prix " required></td>
                                    </tr>
                                </div>
                            ...
                            <div class="d-flex mt-4" style="padding-left: 45%; gap: 2px;">
                                <i><a href="Enregistrement.reprise.php" class="cancel btn btn-danger ms-4">annuler</a></i>
                                <i><a href="....." class="connect btn btn-success ms-4">Valider</a></i>
                            </div>
