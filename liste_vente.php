                    ...
                    <div class="col-lg-12" id="contenu">
                        <div class="row">
                            ...
                            <div class="bt" style="background-color: white; margin: 3%; width: 95%;">
                                ...
                                <center>
                                    <i><h3 style="color:rgb(47, 47, 87);">LISTE DES VENTES</h3></i>
                                </center>
                                    ...
                                    <tbody>
                                        ...
                                        <td><?=$cpt?></td>
                                            ...
                                            <td>
                                                ...
                                                |
                                                <a href="supprimervente.php?ID=<?=$row['id']?>" onclick="return confirmer();" class="fa fa-trash text-danger"></a> 
                                            </td>
                                        </tr> 
                                        <script>
                                            function confirmer() {
                                        ...
                                        <?php $cpt= $cpt+1;}?>
                                        <?php }else{ ?>
                                            <th colspan="11">oups!!! Aucun personnel trouvé</th>   
                                            <?php }?>
