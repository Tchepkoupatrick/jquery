                    ...
                    <div class="col-lg-12" id="contenu">
                        <div class="row">
                            ...
                            <div class="bt" style="background-color: white; margin: 3%; width: 95%;">
                                ...
                                <center>
                                    <i><h3 style="color:rgb(47, 47, 87);">LISTE FINANCEMENT</h3></i>
                                </center>
                                ...
                                <?php foreach($result as $row){ ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$row['email']?></td>
                                            <td><?=$row['contact']?></td>
                                            <td><?=$row['montant_a_financer']?></td>
                                            <td><?=$row['marque']?></td>
                                            <td><?=$row['modele']?></td> 
                                            <td><?=$row['prix_total']?></td>
                                            <td><?=$row['duree_du_pret']?></td>
                                            <td>
                                                <a href="modif.php?ID=<?=$row['id']?>" class="fa fa-refresh text-success"></a>
                                                |
                                                <a href="supprimerfinancement.php?ID=<?=$row['id']?>" onclick="return confirmer();" class="fa fa-trash text-danger"></a> 
                                            </td>
                                        </tr> 
                                        ...
                                        <?php $cpt= $cpt+1;}?>
                                        <?php }else{ ?>
                                            <th colspan="10">oups!!! Aucun personnel trouvé</th>   
                                            <?php }?>
                                    </tbody>
                                </table>
                            </div>
