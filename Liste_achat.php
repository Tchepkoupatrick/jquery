            ...
            <div>
                    ...
                    <div id="accordion">
                        ...
                        <div class=" hiding" style="font-size: 17px;">
                            <a href="Ajout_personnel.php"><i class="fa fa-plus mx-3"> </i>ajoute du personnel</a><br>
                    ...
                    <div class="col-lg-12" id="contenu">
                        <div class="row">
                            ...
                            <div class="bt" style="background-color: white; margin: 3%; width: 95%;">
                                ...
                                <center>
                                    <i><h3 style="color:rgb(47, 47, 87);">LISTE DES ACHATS</h3></i>
                                </center>
                                ...
                                <table id="e" class="table table-striped" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Kilométrage</th>
                                            <th>prix d'achat</th>
                                            <th>Deta de paiement</th>
                                            <th>mode de paiement<th></th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <?php if ($result){ $cpt=1; ?>
                                    ...
                                    <tbody>
                                        ...
                                        <td><?=$cpt?></td>
                                            ...
                                            <td>
                                                ...
                                                |
                                                <a href="supprimerachat.php?ID=<?=$row['id']?>" onclick="return confirmer();" class="fa fa-trash text-danger"></a> 
                                            </td>
                                        </tr> 
                                        ...
                                        <?php $cpt= $cpt+1;}?>
                                        <?php }else{ ?>
                                            <th colspan="13">oups!!! Aucun personnel trouvé</th>   
                                            <?php }?>
                                    </tbody>
                                </table>
                            </div>
