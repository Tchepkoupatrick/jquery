                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">NOUVEL EMPLOYE</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Matricule :<span style="color: white;">fffffff</span></b>
                                        <td><input type="text" name="matri" size="30" placeholder="coe4567" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6">
                                    <tr>
                                        <b>Nom :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" name="nom" size="30" placeholder="Nom Complet" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Email :<span style="color: white;">ffffffffffff</span></b>
                                        <td><input type="email" name="email" size="30" placeholder="Email" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>photo: <span style="color: white;">ff</span></b>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Date naissance: </b>
                                        <td><input type="date" name="dnaissance" style="width: 57%;" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Contact :<span style="color: white;">fffffffff</span></b>
                                        <td><input type="text" name="contact" size="30" placeholder="Contact Client" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Fonction:<span style="color: white;">ffFFFF</span></b>
                                        <td><input type="text" name="fonction" size="31" placeholder="Poste" required></td>
                                    </tr>
                                </div>
                               
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Salaire:<span style="color: white;">ffffffffff</span></b>
                                        <td><input type="text" name="salaire" size="30" placeholder="Montant" required></td>
                                    </tr>
                                </div>

                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <input type="hidden" name="dol" id='dol' value='<?php echo $id; ?>'>
                                    </tr>
                                </div>
                                
                            </div>
                            <div class="d-flex mt-4" style="padding-left: 45%; gap: 2px;">
                            <button type="submit" name="done" id='done' style="background-color: lightgreen; border-color: aqua; text-align: left;">Envoyer</button>
                            <button type="reset" style="background-color : red; border-color: aqua; text-align: left;">Effacer</button>
                            </div>
