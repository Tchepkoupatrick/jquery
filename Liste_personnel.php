                    ...
                    <div class="col-lg-12" id="contenu">
                        <div class="row">
                            ...
                            <div class="bt" style="background-color: white; margin: 3%; width: 95%;">
                                ...
                                <center>
                                    <i><h3 style="color:rgb(47, 47, 87);">LISTE DU PERSONNEL</h3></i>
                                </center>
                                ...
                                <?php foreach($result as $row){ ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$row['nom']?></td> 
                                            <td><?=$row['email']?></td>
                                            <td><img src="<?= ''. $row['photo']; ?>" width="40" height="45" alt="Photo"></td>
                                            ...
                                            <td>
                                                ...
                                                |
                                                <a href="supprimerpersonnel.php?ID=<?=$row['id']?>" onclick="return confirmer();" class="fa fa-trash text-danger"></a> 
                                            </td>
                                        </tr> 
