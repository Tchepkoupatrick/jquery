...
<head>
    ...
    <title>Enregistrement.achat</title>
</head>

<body>
    <form action="enterachat.php" method="POST">
                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">Enregistrement Achat</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <tr>
                                        ...
                                        <td><input type="text" size="30" name="marque" placeholder="Marque du vehicule" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Email :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="email" size="30" name="mail" placeholder="Email" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Modèle :<span style="color: white;">fffffffffff</span></b>
                                        <td><input type="text" size="30" name="model" placeholder="  Modèle du vehicule" required></td>
                                    </tr>
                                </div> 
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        ...
                                        <td><input type="number" size="0" name="annee" placeholder="  année d'imatriculation" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>prix d'achat :<span style="color: white;">ffffffffffffffff</span></b>
                                        <td><input type="number" size="30" name="paye" placeholder="  Montant payé" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        ...
                                        <td><input type="date" size="30" name="mode" placeholder="  Montant payé" required></td>
                                    </tr>
                                </div>
