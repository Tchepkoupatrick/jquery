                ...
                <div class="col-lg-12" id="contenu">
                    <div class="row">
                        ...
                        <div class="btn" style="background-color: white; margin: 3%; width: 95%;">
                            <center>
                                <h3 style="color: rgb(49, 49, 107); margin: 40PX;">Enregistrement d'un rendez-vous</h3>
                            </center>
                            <hr>
                            <div class="row">
                                <div class="col-lg-6">
                                    <tr>
                                        ...
                                        <td><input type="text" size="30" name="nom" placeholder="  Nom" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6">
                                    <tr>
                                        <b>prenom :<span style="color: white;">ffffffffff</span></b>
                                        <td><input type="text" size="30" name="prenom" placeholder="  prenom" required></td>
                                    </tr>
                                </div>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Contact :<span style="color: white;">ffffffffffffffffffffff</span></b>
                                ...
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>opération :<span style="color: white;">ffffffffffffffffffff</span></b>
                                        <td><input type="text" size="0" name="operation" placeholder="  opération" required></td>
                                    </tr>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Date :<span style="color: white;">fffffffffffffffffffffffffffffFFFF</span></b>
                                        <td><input type="date" size="31" name="datee" placeholder=" date" required></td>
                                    </tr>
                                </div>
                               
                                <div class="col-lg-6 mt-3">
                                    <tr>
                                        <b>Heure :<span style="color: white;">fffffffffffffffffffffffff</span></b>
                                        <td><input type="time" size="30" name="heure" placeholder="  Montant payé" required></td>
                                    </tr>
                                </div>
